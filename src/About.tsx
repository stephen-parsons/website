    ...
    <section className="section info">
      ...
      <div>
        ...
        <p>
          ...
          change in my life and decided to attend a coding bootcmap in
          Washington, DC called Coding Dojo at the suggestion of my brother, an
          engineer at Microsoft. I instantly became enamored with fullstack
          application development and learned I had a particular skill for
          problem solving and learning new technologies, which I still hone to
          this day. See my experience section to learn more!
        </p>
        <br />
        <p>
